...
import com.example.desafioimagem2.codes_images.space.CosineSimilarity;
import com.example.desafioimagem2.codes_images.space.EuclideanDistance;
...
public class Image {
    ...
    public static Matrix[] componentExtract(String fileName) throws IOException {
